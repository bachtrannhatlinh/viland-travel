...
export default function FlightBookingPage() {
  ...
  const calculateTotalAmount = () => {
    ...
    const basePrice =
      flight.pricing[selectedClass]?.price ||
      flight.pricing[FlightClass.ECONOMY].price;
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        if (res.message === msgError.noToken) {
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    ...
                    <div className="font-semibold text-primary-600">
                      {bookingData.selectedClass === FlightClass.ECONOMY
                        ? "Phổ thông"
                        : bookingData.selectedClass === FlightClass.BUSINESS
                        ? "Thương gia"
                        : bookingData.selectedClass === FlightClass.FIRST
                        ? "Hạng nhất"
                        : "Phổ thông đặc biệt"}
                    </div>
                  </div>
